...
export default function ProfilePage() {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      if (!u) {
        const fetched = await authApi.fetchCurrentUser();
        if (!fetched) {
          navigate("/");
          return;
        }
        setUser(fetched);
        console.log("[Profile] Loaded user (fetched)", fetched);
        return;
      }
      setUser(u);
      console.log("[Profile] Loaded user (cached)", u);
    };
    load();
  }, [navigate]);
  ...
  const handleSave = async () => {
    if (!user?.id || !editedUser) {
      console.error("[Profile] Cannot save: missing user.id or editedUser", {
        user,
        editedUser,
      });
      return;
  ...
  return (
    ...
    >
      ...
      <Button
        variant="ghost"
        className="absolute top-6 left-6 z-20 flex items-center gap-2 bg-white text-black shadow-md hover:bg-gray-100"
        onClick={() => navigate(-1)}
      >
        <ArrowLeft size={18} />
        Back
      ...
      <div className="relative z-10 w-full max-w-3xl">
        <Card className="p-10 rounded-3xl shadow-2xl bg-card/95 space-y-10">
          {/* Header */}
                ...
                {isEditing ? (
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Bolivia (Plurinational State of)">
                        Bolivia (Plurinational State of)
                      </SelectItem>
                      <SelectItem value="Bonaire, Sint Eustatius and Saba">
                      ...
                      <SelectItem value="British Indian Ocean Territory (the)">
                      ...
                      <SelectItem value="Cayman Islands (the)">
                        Cayman Islands (the)
                      </SelectItem>
                      <SelectItem value="Central African Republic (the)">
                      ...
                      <SelectItem value="Cocos (Keeling) Islands (the)">
                        Cocos (Keeling) Islands (the)
                      </SelectItem>
                      <SelectItem value="Colombia">Colombia</SelectItem>
                      <SelectItem value="Comoros (the)">
                        Comoros (the)
                      </SelectItem>
                      ...
                      <SelectItem value="Cook Islands (the)">
                        Cook Islands (the)
                      </SelectItem>
                      ...
                      <SelectItem value="Dominican Republic (the)">
                      ...
                      <SelectItem value="Falkland Islands (the) [Malvinas]">
                        Falkland Islands (the) [Malvinas]
                      </SelectItem>
                      <SelectItem value="Faroe Islands (the)">
                        Faroe Islands (the)
                      </SelectItem>
                      ...
                      <SelectItem value="French Southern Territories (the)">
                      ...
                      <SelectItem value="Korea (the Democratic People's Republic of)">
                        Korea (the Democratic People's Republic of)
                      </SelectItem>
                      <SelectItem value="Korea (the Republic of)">
                        Korea (the Republic of)
                      </SelectItem>
                      <SelectItem value="Kuwait">Kuwait</SelectItem>
                      <SelectItem value="Kyrgyzstan">Kyrgyzstan</SelectItem>
                      <SelectItem value="Lao People's Democratic Republic (the)">
                      ...
                      <SelectItem value="Marshall Islands (the)">
                      ...
                      <SelectItem value="Moldova (the Republic of)">
                      ...
                      <SelectItem value="Netherlands (the)">
                        Netherlands (the)
                      </SelectItem>
                      <SelectItem value="New Caledonia">
                        New Caledonia
                      </SelectItem>
                      ...
                      <SelectItem value="Northern Mariana Islands (the)">
                      ...
                      <SelectItem value="Philippines (the)">
                        Philippines (the)
                      </SelectItem>
                      ...
                      <SelectItem value="Republic of North Macedonia">
                        Republic of North Macedonia
                      </SelectItem>
                      <SelectItem value="Romania">Romania</SelectItem>
                      <SelectItem value="Russian Federation (the)">
                        Russian Federation (the)
                      </SelectItem>
                      <SelectItem value="Rwanda">Rwanda</SelectItem>
                      <SelectItem value="Réunion">Réunion</SelectItem>
                      <SelectItem value="Saint Barthélemy">
                        Saint Barthélemy
                      </SelectItem>
                      <SelectItem value="Saint Helena, Ascension and Tristan da Cunha">
                      ...
                      <SelectItem value="Saint Martin (French part)">
                      ...
                      <SelectItem value="Sint Maarten (Dutch part)">
                      ...
                      <SelectItem value="Taiwan (Province of China)">
                      ...
                      <SelectItem value="Turks and Caicos Islands (the)">
                        Turks and Caicos Islands (the)
                      </SelectItem>
                      <SelectItem value="Tuvalu">Tuvalu</SelectItem>
                      <SelectItem value="Uganda">Uganda</SelectItem>
                      <SelectItem value="Ukraine">Ukraine</SelectItem>
                      <SelectItem value="United Arab Emirates (the)">
                        United Arab Emirates (the)
                      </SelectItem>
                      <SelectItem value="United Kingdom of Great Britain and Northern Ireland (the)">
                        United Kingdom of Great Britain and Northern Ireland
                        (the)
                      </SelectItem>
                      <SelectItem value="United States Minor Outlying Islands (the)">
                        United States Minor Outlying Islands (the)
                      </SelectItem>
                      <SelectItem value="United States of America (the)">
                        United States of America (the)
                      </SelectItem>
                      <SelectItem value="Uruguay">Uruguay</SelectItem>
                      <SelectItem value="Uzbekistan">Uzbekistan</SelectItem>
                      <SelectItem value="Vanuatu">Vanuatu</SelectItem>
                      <SelectItem value="Venezuela (Bolivarian Republic of)">

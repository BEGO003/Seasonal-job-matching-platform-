...
public class ResumeController {
    ...
    @PatchMapping("/{userId}")
    public ResponseEntity<?> editUser(@PathVariable long userId,@Valid @RequestBody ResumeEditDTO dto){
        try {
    ...
    public ResponseEntity<String> deleteJob(@PathVariable Long userId){
